...
static const int MASTERNODE_SYNC_TIMEOUT_SECONDS = 30; // our blocks are 1.9 minutes so 30 seconds should be fine

static const int MASTERNODE_SYNC_ENOUGH_PEERS    = 2;
