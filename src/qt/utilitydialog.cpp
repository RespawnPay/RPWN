    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("RPWN Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About RPWN Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  RPWN-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the RPWN in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RPWN, 0.1 RPWN, 1 RPWN and 10 RPWN -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("RPWN Core is shutting down...") + "<br /><br />" +
