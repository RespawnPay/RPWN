    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("RPWN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RPWN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and RPWN: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About RPWN Core"), this);
    aboutAction->setStatusTip(tr("Show information about RPWN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RPWN Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RPWN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RPWN addresses"));
    ...
    openAction->setStatusTip(tr("Open a RPWN: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RPWN Core help message to get a list with possible RPWN Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("RPWN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RPWN network", "", count));
    } else {
...
{
    QString strTitle = tr("RPWN Core"); // default title
