...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all RPWN related functionality
...
/*
    ...
    allow endless transaction that would bloat RPWN and make it unusable. To
