...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RPWNNetwork") type = RPWNNetwork;
    if(strType == "RPWNNetworkVariable") type = RPWNNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RPWNNetwork) s = "RPWNNetwork";
    if(type == RPWNNetworkVariable) s = "RPWNNetworkVariable";
