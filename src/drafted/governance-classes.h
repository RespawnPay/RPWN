 ...
 *
 *   // network
 *   CRPWNNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.RPWN.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CRPWNNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: RPWNNetwork
// //   -- signature requirements : Key1(User)
// class CRPWNNetworkVariable : public CGovernanceObject
// {
// private:
