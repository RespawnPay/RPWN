...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("RPWN Core RPWN-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  RPWN-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded RPWN transaction") + "\n" +
              "  RPWN-tx [options] -create [commands]   " + _("Create hex-encoded RPWN transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded RPWN transaction
