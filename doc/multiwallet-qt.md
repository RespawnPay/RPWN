...
Only requiring some minor changes is RPWN.cpp.
...
Changes to RPWN.cpp
----------------------
RPWN.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
