...
This mechanism has been integrated into Bitcore-Node-RPWN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/RPWNpay/insight-api-RPWN#web-socket-api](https://github.com/RPWNpay/insight-api-RPWN#web-socket-api)
* API: [https://github.com/RPWNpay/insight-api-RPWN#instantsend-transactions](https://github.com/RPWNpay/insight-api-RPWN#instantsend-transactions)
...
By default, the RPWN Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the RPWN Core daemon:
